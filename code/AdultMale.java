...
/*
This class holds all the information for the Adult Male client type.
*/
...
public class AdultMale extends Client{
    ...
    //Constructor for the AdultMale class that sets all the variables, it uses the percentageToValue method to convert the different food group
    //percentages into actual numbers using the total amount of calories
    public AdultMale(int grainsPercent, int proteinsPercent, int fruitsVeggiesPercent, int otherPercent, int totalCalories) throws IllegalArgumentException{
